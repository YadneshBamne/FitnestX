...
class _SleepScheduleViewState extends State<SleepScheduleView> {
  late CalendarAgendaController _calendarAgendaControllerAppBar;
  ...
  void initState() {
    super.initState();
    _calendarAgendaControllerAppBar = CalendarAgendaController();
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      IconButton(
                        onPressed: () {
                          _calendarAgendaControllerAppBar.goToPreviousDate();
                        },
                      ...
                      IconButton(
                        onPressed: () {
                          _calendarAgendaControllerAppBar.goToNextDate();
                        },
